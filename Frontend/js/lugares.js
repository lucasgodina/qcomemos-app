document.addEventListener('DOMContentLoaded', function () {
	...
	const exampleReviewsJardin = document.getElementById(
		'exampleReviewsElJardin'
	);
	...
	const exampleReviewsBodegon = document.getElementById(
		'exampleReviewsBodegon'
	);

	const ratingStarsJardin = document.querySelectorAll(
		'#modalElJardin .star-rating input'
	);
	const ratingStarsBodegon = document.querySelectorAll(
		'#modalElBodegon .star-rating input'
	);
	...
	function addToFavorites(placeName, placeAddress, placeImage) {
		...
		const isAlreadyFavorite = favoritePlaces.some(
